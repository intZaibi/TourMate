...
export function RecommendationsFooter({setPopularDestination}:any) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-bold">Tourmate</h3>
            </div>
            <p className="text-gray-400 mb-4">
              Your AI-powered travel companion that creates personalized trip recommendations based on your preferences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white transition">How It Works</Link></li>
            ...
            <form className="mb-2">
              <div className="flex">
                <Input
                  ...
                  sx={{color:"white", borderRadius: "5px", height: "2.5rem", width: "75%", paddingX: "10px", border:"1px solid white"}}
                  className="bg-gray-700 text-white rounded-r-none focus:ring-2 focus:ring-amber-500"
                />
                <Button sx={{background: 'orange', color:"white"}} type="submit" className="bg-amber-500 hover:bg-amber-600 text-white rounded-l-none">

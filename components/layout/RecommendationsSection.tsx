...
import { Edit, PlusCircle, Save, Share2, MapPin, Bed, Utensils, Calculator, Info, MinusCircle, MessageCircleCode } from "lucide-react";
            ...
            {recommendation && (
              <>
                ...
                <div className="flex justify-center mt-12 gap-x-4">
                  ...
                  <Button variant="contained" sx={{textTransform: 'none'}} className="flex items-center">
